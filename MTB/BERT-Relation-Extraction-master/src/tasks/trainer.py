...
def train_and_fit(args):
    ...
    if args.model_no == 0:
        unfrozen_layers = ["classifier", "pooler", "encoder.layer.11", "encoder.layer.0", "encoder.layer.1", \
                            "encoder.layer.2", "encoder.layer.3", "encoder.layer.4", "encoder.layer.5", \
                            "encoder.layer.6", "encoder.layer.7", "encoder.layer.8", "encoder.layer.9", "encoder.layer.10", \
